			...
			<table border="0" cellpadding="2" cellspacing="2">
				<tr>
					<td>
						...
						<p>
							This year, sessions are divided into two terms, fall and spring. The Club <a href="<c:url value="/home/calendar.do" />">calendar</a> details regular sessions and exceptions. Please visit this home page of this website for last-minute cancellation notices and announcements, or call the Club&rsquo;s voice mail at 203-432-1233.
						</p>
						<p>
				...
				<tr>
					<td>
						...
						To <a href="<c:url value="/home/membership.do" />">join YFSC</a>, send in a signed <a href="<c:url value="/Content/files/attach/11-12-Mbrship_FormFall.pdf" />">membership application</a> and <a href="<c:url value="/Content/files/attach/release.pdf" />">emergency medical form</a>, with a check for YFSC and USFS dues and applicable session fees. &nbsp; Mail this to our administrative assistant, &nbsp; Mary D'Agostino, &nbsp; 19 Douglas Road, Hamden, CT &nbsp; 06518-1859.&nbsp; Please mail early!
						<p>
				...
				<tr>
					<td>
						<p>
							...
							The Yale Figure Skating Club, Inc. (YFSC) is an independent non-profit organization that is sanctioned by United States Figure Skating (USFS). It is tax exempt under sections 501(c)(3) and 509(a)(2) of the Internal Revenue Code of 1986. Contributions are welcome and are tax deductible to the extent permitted by law. Our bylaws are available on the <a href="<c:url value="/home/byLaws.do" />">Bylaws</a> page of this website
						</p>
						<p>
